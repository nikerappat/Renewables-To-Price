...
* Day-ahead prices are calculated based on forecasts from the previous day. This analysis uses actual, measured data. Forecasts and Actuals usually correlate strongly but this is not evidence of the price formation mechanism
